        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-gray-900">JNIMUN'25</span>
            </div>
            <div className="flex items-center space-x-4">
              <Link href="/admin" className="text-gray-600 hover:text-blue-600 transition-colors">Admin</Link>
              <Link href="/member" className="text-gray-600 hover:text-purple-600 transition-colors">Member</Link>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Advanced registration and tracking system for the Jordan National International Model United Nations 2025.
              </p>
            </div>
