...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    switch (dataType) {
      case 'all':
        ...
        await query(`
          UPDATE delegates SET
            day1_session_attended = FALSE, day1_food = FALSE,
            day2_session_attended = FALSE, day2_food = FALSE,
            day3_session_attended = FALSE, day3_food = FALSE,
            day4_session_attended = FALSE, day4_food = FALSE,
            opening_ceremony_attended = FALSE, opening_ceremony_food = FALSE,
      ...
      case 'bus':
        await query('DELETE FROM activity_timeline WHERE activity_type = \'other\' AND metadata->>\'type\' = \'bus\'')
        break
