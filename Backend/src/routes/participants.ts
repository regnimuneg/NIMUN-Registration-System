...
async function getParticipantTrackingData(
  ...
  if (isDelegate) {
    const delegateData = await query(`
      SELECT 
        day1_session_attended, day1_food, day1_comments, day1_checkin, day1_checkout, day1_bus_checkin, day1_bus_checkout,
    ...
    if (delegateData.rows.length > 0) {
      ...
      attendanceData = {
        sessions: {
          day1: { attended: d.day1_session_attended || false, lunch: d.day1_food || false, comments: d.day1_comments || null, checkin: d.day1_checkin || null, checkout: d.day1_checkout || null, busCheckIn: d.day1_bus_checkin || null, busCheckOut: d.day1_bus_checkout || null },
          day2: { attended: d.day2_session_attended || false, lunch: d.day2_food || false, comments: d.day2_comments || null, checkin: d.day2_checkin || null, checkout: d.day2_checkout || null, busCheckIn: d.day2_bus_checkin || null, busCheckOut: d.day2_bus_checkout || null },
    ...
    if (memberData.rows.length > 0) {
      ...
      attendanceData = {
        sessions: {
          day1: { attended: m.day1_session_attended || false, lunch: m.day1_food || false, comments: m.day1_comments || null, checkin: m.day1_checkin || null, checkout: m.day1_checkout || null, busCheckIn: m.day1_bus_checkin || null, busCheckOut: m.day1_bus_checkout || null },
          day2: { attended: m.day2_session_attended || false, lunch: m.day2_food || false, comments: m.day2_comments || null, checkin: m.day2_checkin || null, checkout: m.day2_checkout || null, busCheckIn: m.day2_bus_checkin || null, busCheckOut: m.day2_bus_checkout || null },
